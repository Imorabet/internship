        ...
        <AuthenticatedLayout auth={props.auth} errors={props.errors}>
            ...
            <div className="flex gap-2 h-screen">
                ...
                <div className="flex flex-col w-full">
                    <div class="max-w-3xl mx-6 p-4 bg-white rounded-md shadow my-3">
                        <h1 class="text-md font-medium mb-1">assign stuff</h1>
                    ...
                    <div className="xl:w-[75%] md:w-8/12 mb-1 md:mb-0 px-2 mx-4 mt-1">
