...
export default function ListModule(props){
    ...
    async function deleteModule(e) {
        e.preventDefault();
        destroy(route("module.destroy", data.id), {
            preserveScroll: true,
            ...
            <form
                    ...
                    >
                        ...
                        <div class="flex flex-col  gap-3 py-4">
                            ...
                            <TextInput
                                ...
                                onChange={handleOnChange}
                                required
                                placeholder="Entrer le nom de matiere"
                            />
                        </div>
                ...
                <div className="xl:w-[98%] md:w-[80%] md:mx-2 mb-1 md:mb-0 px-1 mx-4 mt-1">
                                        ...
                                        visiblemodules.map(
                                            (module, index) => (
                                                <tr key={module.id}>
                                                    ...
                                                    {niveauOptions.map(niveau=>niveau.id==module.id_niveaux&&
                                                                    niveau.nom )
                                                            }/
                                                    {filieres1.map(filiere=>filiere.id==module.id_filieres &&
                                                                    filiere.nom)
                                                            }
                                                       </td>
                    ...
                    <ReactPaginate
                        ...
                        pageCount={Math.ceil(
                            props.modules.length / pagination.itemsPerPage
                        )}
